/*
** Astrolog (Version 7.80) File: astrolog.h
**
...
/*
** This is the main header file for Astrolog. It includes all sub-headers
** in the correct order to resolve dependencies:
**
**   astrolog_config.h   - Feature flags and platform configuration
**   astrolog_constants.h - Program constants (after system includes)
**   astrolog_enums.h    - All enumerations
**   astrolog_types.h    - Type definitions and structures
**   astrolog_macros.h   - Macro functions
