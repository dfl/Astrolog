...
GS gs = {
    ...
    ftBmp,
#endif
    fTrue,  fTrue,  fFalse, fFalse,     fTrue,    fTrue,  055550, 0,
    5,      5,      5,      5,          0,        fFalse, fTrue,  fTrue,
    fFalse, fFalse, fFalse, fFalse,     fFalse,   fFalse, fFalse, fFalse,
    fFalse, fFalse, fFalse, fFalse,     fTrue,    fFalse, fFalse, fFalse,
    fFalse, 0,      fFalse, DEFAULTX,   DEFAULTY,
#ifdef WIN
    -10,
#else
    0,
#endif
    200,    100,    0,      0,          0,        3,      1,      0,
    0.0,    0.0,    oMoo,   BITMAPMODE, 25.0,     1,      2,      8.5,
    11.0,   NULL,   0,      25,         11,       1,      NULL,   oCore,
    0.0,    1000,   0,      600,        1,        1,      1,      2,
    2,      1,      fFalse, fFalse,     fTrue,    7,      5,      NULL,
    NULL};
...
CHOOSECOLOR chc = {sizeof(CHOOSECOLOR),      (HWND)NULL, (HWND)NULL, 0,   NULL,
...
CONST KV rgbbmpDef[cColor] = {0x000000, 0x00007F, 0x007F00, 0x007F7F,
                              0x7F0000, 0x7F007F, 0x7F7F00, 0xBFBFBF,
                              0x7F7F7F, 0x0000FF, 0x00FF00, 0x00FFFF,
                              0xFF0000, 0xFF00FF, 0xFFFF00, 0xFFFFFF};
CONST KV rgbbmpDef2[cColor] = {0x000000, 0x00009F, 0x007F00, 0x007F7F,
...
#endif
#ifdef WIN
CONST int ikPalette[cColor] = {-0, -1, 1,  4,  6,  3, -8, 5,
                               -3, -2, -4, -5, -7, 2, 7,  -6};
...
CONST char *rgszFontName[cFont] = {
    szAppNameCore,    "Wingdings",      "Astro",       "EnigmaAstrology",
    "HamburgSymbols", "Astronomicon",   "Courier New", "Consolas",
    "Arial",          "Hanks Nakshatra"};
...
CONST char *szDrawObject[objMaxG];

CONST char *szDrawObjectDef2[objMaxG] = {
    ...
    "",                                                 // 7th Cusp
    ""};                                                // 10th Cusp
CONST char *szDrawObject2[objMaxG];
...
CONST char *szDrawHouse[cSign + 1] = {"",
                                      ...
                                      "NRLU2R2D4L2U2",
                                      "NRLU2R2D4L2",
                                      "BH2NLD4NLRBR2U4R2D4L2",
                                      "BH2NLD4NLRBR2RNRU4L",
                                      "BH2NLD4NLRBR2NR2U2R2U2L2"};

CONST char *szDrawHouse2[cSign + 1] = {"",
                                       "BD4NL2NR2U8G2",
                                       "BH2BUER2FD2G4DR4",
                                       "BH2BUER2FD2GNLFD2GL2H",
                                       "BH2BU2D4R3NU4NRD4",
                                       "BE2BU2L4D4R3FD2GL2H",
                                       "NL2RFD2GL2HU6ER2F",
                                       "",
                                       "NRLHU2ER2FD2GFD2GL2HU2E",
                                       "NR2LHU2ER2FD6GL2H",
                                       "BH4NG2D8NL2R2BR5HU6ER2FD6GL2",
                                       "BH4NG2D8NL2R2BR4R2NR2U8G2",
                                       "BH4NG2D8NL2R2BR4NR4UE4U2HL2G"};

CONST char *szDrawHouse3[cSign + 1] = {"",
                                       "BD6NL3NR3U12G3",
                                       "BH3BU2ER4FD4G6DR6",
                                       "BH3BU2ER4FD3G2NL2F2D3GL4H",
                                       "BH3BU3D6R5NU6NRD6",
                                       "BE3BU3L6D6R5FD4GL4H",
                                       "NL3R2FD4GL4HU10ER4F",
                                       "",
                                       "NR2L2HU4ER4FD4GFD4GL4HU4E",
                                       "NR3L2HU4ER4FD10GL4H",
                                       "BH6NG3D12NL3R3BR7HU10ER4FD10GL4",
                                       "BH6NG3D12NL3R3BR6R3NR3U12G3",
                                       "BH6NG3D12NL3R3BR6NR6UE6U4HL4G"};

CONST char *szDrawAspectDef[cAspect3 + 1] = {
    "",
    ...
    "BE4G8R8",                                         // SemiSquare
    "BD2L3U6R6D6L3D2R2",                               // SesquiQuadrate
    ...
    "BL3BDED4NLRBR3NHEU2HGND2BE3L7NLU2NLR3ND2R3ND2R",  // TriDecile
    "BH3BDED6NLRBR2RNRU6G",                            // Undecile
    "BL3BDED4NLRBR2RNRU4GBE3LNLU2NRLBL4LNLD2NLR",      // BiUndecile
    "BL3BDED4NLRBR2RNRU4GBE3L7NLU2NLR3ND2R3ND2R",      // TriUndecile
    "BL3BDED4NLRBR2RNRU4GBH3LNLU2NLRBR2F2E2",          // QuadUndecile
    "BL3BDED4NLRBR2RNRU4GBU3BLNH2E2",                  // QuinUndecile
    "BU4BLD8BR2U8",                                    // Parallel
    "BU4BLD8BR2U8BF3BLL6BD2R6",                        // Contraparallel
    "ND3NL3HND5LND5GND3NR3GNR5DNR5FNR3FRE2UHE4",       // Conjunction Eclipse
    "BGL2ND3GNR3DNR3FRNU3EU2E2U2NR3END3RND3FDNL3GL2"}; // Opposition Eclipse
CONST char *szDrawAspect[cAspect3 + 1];

CONST char *szDrawAspectDef2[cAspect3 + 1] = {
    "",
    ...
    "",                                           // TriSeptile
    "",                                           // QuatroNovile
    "BL6BD2E2D8NL2R2BR5NHR2EU6HL2GND6BDBE6L14NL2U4NL2R6ND4R6ND4R2", // TriDecile
    "",                                                             // Undecile
    "",                                                   // BiUndecile
    "",                                                   // TriUndecile
    "",                                                   // QuadUndecile
    ...
    "",                                                   // Parallel
    "",                                                   // Contraparallel
    "BELHND10L2ND10L2ND10G3NR10D2NR10D2NR10F3R4E3U4HUE7", // Conjunction Eclipse
    "BG3HND6L2ND6G2NR6D2NR6F2R2E2U2HE6HNR6U2NR6E2ND6R2ND6F2D2G2L2H"};
// Opposition Eclipse
CONST char *szDrawAspect2[cAspect3 + 1];

// Vector font for smaller 6x10 unit characters.
CONST char *szDrawCh[256 - 32] = {"",
                                  ...
                                  "BR3NFL2GD4FR2EUHL3",
                                  "R4DG4D",
                                  "BDDFNR2GDFR2EUHEUHL2G",
                                  "BD5FR2EU4HL2GDFR3", // Numbers
                                  ...
                                  "BRF3G3",
                                  "BDER2FDGLDBD2D0",
                                  "BF2DFEU2HL2GD4FR2", // Special Characters
                                  ...
                                  "BR2DNL2NR2D4NL2NR2D",
                                  "BR2NGF",
                                  "RDLNUBR4G2L2BD2RDLUBR3RDLU",
                                  "BD5FR2EUHL2HUER2NFBU2GH",
                                  "BF2FG",
                                  "BRNRGD4FRNR2U3NR2U3R2",
                                  "",
                                  "R4DG4DR4BU8BLGH",
                                  "", // 80-8F
                                  ...
                                  "",
                                  "BR2D0BD2D4",
                                  "BR2DND6NLRFBL4NED3FR2E",
                                  "BD6RNR3U3NLNR2U2ERF",
                                  "BDFEFNEFGNFGHNGHE",
                                  "F2NE2DNL2NR2D2NL2NR2D",
                                  "BR2D2BD2D2",
                                  "BD6R3EHNL2EHL2GFBU2HER3",
                                  "BRD0BR2D0",
                                  "BD2ER2FD2GL2HU2BR3LGFR",
                                  "BF4U2NUG2LHU2ER2FBD5L4",
                                  "BD3NFEBR3GF",
                                  "BD2R4D",
                                  "BD3BRR2",
                                  "BD2ER2FD2GL2HU2BRND2R2DLNLF",
                                  "BRR2", // A0-AF
                                  ...
                                  "BDD2FR2EU2HL2G",
                                  "BD2FGBR3EH",
                                  "RND2BR3BDG4BDBR4UNULU",
                                  "RND2BR3BDG4BDBR4LURUL",
                                  "RD2LBURBR3G4BDBR4UNULU",
                                  "BR2D0BD2DLGDFR2E", // B0-BF

                                  "BD6U4E2F2D2NL4D2BU7BLH",
                                  "BD6U4E2F2D2NL4D2BU7BL3E",
                                  "BD6U4E2F2D2NL4D2BU7BLHG",
                                  "BD6U4E2F2D2NL4D2BU8GHG",
                                  "BD6U4E2F2D2NL4D2BU8BLD0BL2D0",
                                  "BD6U4E2F2D2NL4D2BU8BL2D0",
                                  "BD6U2NR2U2E2NR2D3NR2D3R2",
                                  "BR3NFL2GD4FR2EBG2DL",
                                  "NR4D3NR3D3R4BU7BLH",
                                  "NR4D3NR3D3R4BU7BL3E",
                                  "NR4D3NR3D3R4BU7BLHG",
                                  "NR4D3NR3D3R4BU8BLD0BL2D0",
                                  "BRRNRD6NLRBU7H",
                                  "BRRNRD6NLRBU7BL2E",
                                  "BRRNRD6NLRBU7HG",
                                  ...
                                  "BRGD4FR2EU4HL2BUEF",
                                  "BRGD4FR2EU4HL2BUEFE",
                                  "BRGD4FR2EU4HL2BU2D0BR2D0",
                                  "BDF2NE2NG2F2",
                                  "BRGD4FR2EU4HNL2BRGDG2DG",
                                  "D5FR2EU5BHBLH",
                                  "D5FR2EU5BHBLE",
                                  "D5FR2EU5BHHG",
                                  "D5FR2EU5BHBUD0BL2D0",
                                  "D2FRND3REU2BHBLE",
                                  "D5NDR3EU2HL3",
                                  "BD6U5ERFDGF2GL", // D0-DF

                                  "BF4G2LHU2ER2FD3BU6BLH",
                                  "BF4G2LHU2ER2FD3BU6BL2E",
                                  "BF4G2LHU2ER2FD3BU6BLHG",
                                  "BF4G2LHU2ER2FD3BU7GHG",
                                  "BF4G2LHU2ER2FD3BU6BLD0BL2D0",
                                  "BF4G2LHU2ER2FD3BU6BL2D0",
                                  "BD2R3FDL3GDR2NR2U4",
                                  "BF4BUHL2GD2FR2EBG3RU2",
                                  "BD4R4UHL2GD2FR3BU6BL2H",
                                  "BD4R4UHL2GD2FR3BU7BLG",
                                  "BD4R4UHL2GD2FR3BU6BLHG",
                                  "BD4R4UHL2GD2FR3BU6BLD0BL2D0",
                                  "BEFBD2D4",
                                  "BR2NEBD2D4",
                                  "BRENFBD3D4",
                                  "BRD0BR2D0BLBD2D4", // E0-EF

                                  "BR3DNLNRD2FDGL2HUER2",
                                  "BD2DND3ER2FD3BU7GHG",
                                  "BD3D2FR2EU2HL2NGBU3F",
                                  "BD3D2FR2EU2HL2NGBUBEE",
                                  "BD3D2FR2EU2HL2NGBU2EF",
                                  "BD3D2FR2EU2HL2NGBU2EFE",
                                  "BD3D2FR2EU2HL2NGBU2D0BR2D0",
                                  "BD3R4BH2D0BD4D0",
                                  "BD3D2FR2EU2HL2GD2BDE4",
                                  "BD2D3FRE2ND2U2BH2H",
                                  "BD2D3FRE2ND2U2BH2E",
                                  "BD2D3FRE2ND2U2BUBHHG",
                                  "BD2D3FRE2ND2U2BHBUD0BL2D0",
                                  "BD8R3EU2NU3GL2HU3BE2E",
                                  "D5ND3FR2EU2HL2G",
                                  "BD8R3EU2NU3GL2HU3BEBUD0BR2D0"}; // F0-FF

// Vector font for larger 9x15 unit characters.
CONST char *szDrawCh2[256 - 32] = {
    "",
    "BR3D5BD3D",
    "BR2D3BR3U3",
    "BD3R6BD3L6BF2U7BR2D7",
    "BR3D9BH2BLFR4EU2HL4HUER4F",
    "RDLNUBR6G6BR6DLUR",
    "BD3NF6U2ERFD2G3D2FR2E3",
    "BR3DG",
    "BR4G3D3F3",
    "BR2F3D3G3",
    "BD2F2NG2RNU3ND3RNE2F2",
    "BD4R3NU3ND3R3",
    "BR3BD8DG",
    "BD4R6",
    "BD9BR2RULD",
    "BD7E6", // Special Characters

    "BD2D5NE5F2R2E2U5NLH2L2G2",
    "BR3NG2D9NL2R2",
    "BD2E2R2F2DG6R6",
    "BD2E2R2F2G2NLF2DG2L2H2",
    "D5R4NU5ND4R2",
    "NR6D4R4F2DG2L2H2",
    "BR4NF2L2G2D5F2R2E2UH2L2G2",
    "R6DG6D2",
    "BD2F2NR2G2DF2R2E2UH2E2H2L2G2",
    ...
    "BD3R6BD3L6",
    "BRF4G4",
    "BD2E2R2F2DG2LD2BD2D0",
    "BF3RDLNUDFREU3H2L2G2D5F2R3E", // Special Characters
    ...
    "BD2D5F2R2E2U5H2L2G2",
    "ND9R4F2DG2L4",
    "BD2D5F2R2ENFNH2EU5H2L2G2",
    "ND9R4F2DG2L2NL2F4",
    "BR4NF2L2G2F2R2F2DG2L2H2",
    "R3NR3D9",
    "D7F2R2E2U7",
    "D3FDFDFNDEUEUEU3",
    "D9E3NU2F3U9",
    ...
    "D7ND2F2R2E2U2H2L2G2",
    "BR6BD4HL3G2D2F2R3E",
    "BR6D7ND2G2L2H2U2E2R2F2",
    "BD6R6UH2L2G2D2F2R3E",
    "BD4R2NR4ND5U3ER2F",
    "BD11FR3E2U5H2L2G2D2F2R2E2",
    "D5ND4E2R2F2D4",
    "BR3DBD3D5",
    "BR4DBD3D7GL2H",
    "D6ND3REREREBD6HLHLH",
    ...
    "BD3D5FRENU2FREU5",
    "BD3F3NG3NE3F3",
    "BD3D4F2R2E2NU4D3G2L4",
    "BD3R6G6R6", // Lower Case Letters
    ...
    "BD9BRD0BR2D0BR2D0",
    "BR3BDD2NL2NR2D5",
    "BR3BDD2NL2NR2D3NL2NR2D2",
    "BR3NGF",
    "BRFGHNEBR6GLG2LGBD3EFGHBR4EFGH",
    "BU3BR2FEBD3NF2L2G2F2R2F2DG2L2H2",
    "BR3BD2F2G2",
    "BR2NRG2D5F2RNR3U5NR2U4R3",
    "",
    "R6DG6D2R6BU12BL2GH",
    "", // 80-8F
    ...
    "BRBFEFE",
    "RND2RBR2ND2FNDED2",
    "BD8FR4EUHL4HUER4FBH4FE",
    "BR4BD2G2F2",
    "BD4NED4FREU4HLBR3NGRFD2L3BD2FRE",
    "",
    "BD3R6G6R6BU9BL2GH",
    ...
    "",
    "BR3DBD3D5",
    "BR3D2ND7NL2R2FBL6NED3FR4E",
    "BD9RNR5U4NLNR4U3E2R2F",
    "DFER2FEUBD3NHD2BD3UHNEGL2HGDBU3NFU2E",
    "F3NE3D2NL2NR2D2NL2NR2D2",
    "BR3D3BD3D3",
    "BD8FR4EUHNL4EUHL4GDFBU3HUER4F",
    "BR2D0BR2D0",
    "BD3E2R2F2D2G2L2H2U2BR4LGFR",
    "BRBF4U2NUG2LHU2ER2FBD5L4",
    "BD4NF2E2BR4G2F2",
    "BD4R6D2",
    "BD4BRR4",
    "BD2E2R2F2D2G2L2H2U2BR2ND2R2DLNLF",
    "BRR4", // A0-AF
    ...
    "BR3BD8DL",
    "BRR2D4NL2R2",
    "BR3GD2FR2EU2HL2BLBD6R4",
    "BD2F2G2BR4E2H2",
    "RD3NLRBR4BU2G6BR6ND2NU2L2U2",
    "RD3NLRBR4BU2G6BR6BD2L2U2R2U2L2",
    "R2D2NL2D2L2BR6BU2G6BDBR6UNU2L2U2",
    "BR3D0BD2D2LG2DF2R2E2", // B0-BF

    "BD9U6E3F3D3NL6D3BU10BL2H",
    "BD9U6E3F3D3NL6D3BU10BL4E",
    "BD9U6E3F3D3NL6D3BU10BL2HG",
    "BD9U6E3F3D3NL6D3BU11BLGHG",
    "BD9U6E3F3D3NL6D3BU11BL2D0BL2D0",
    "BD9U6E3F3D3NL6D3BU11BL3D0",
    "BD9U3NR3U3E3NR3D4NR3D5R3",
    "BR4NF2L2G2D5F2R2E2BG3DL",
    "NR6D4NR5D5R6BU10BL3H",
    "NR6D4NR5D5R6BU10BL3E",
    "NR6D4NR5D5R6BU10BL2HG",
    "NR6D4NR5D5R6BU11BL2D0BL2D0",
    "BRR2NR2D9NL2R2BU10BL2H",
    "BRR2NR2D9NL2R2BU10BL2E",
    "BRR2NR2D9NL2R2BU10BLHG",
    "BRR2NR2D9NL2R2BU11BLD0BL2D0", // C0-CF

    "BD4RNRD5R2E3U3H3L2D4",
    "ND9F2DFDFDF2U9BU2BLGHG",
    "BR2G2D5F2R2E2U5H2L2BEH",
    "BR2G2D5F2R2E2U5H2L2BEE",
    "BR2G2D5F2R2E2U5H2L2BUEF",
    "BR2G2D5F2R2E2U5H2L2BUEFE",
    "BR2G2D5F2R2E2U5H2L2BU2D0BR2D0",
    "BDF3NE3NG3F3",
    "BR2G2D5F2R2E2U5H2L2BR4G2DGDGDG2",
    "D7F2R2E2U7BL3BUH",
    "D7F2R2E2U7BL3BUE",
    "D7F2R2E2U7BL2BUHG",
    "D7F2R2E2U7BH2D0BL2D0",
    "D3F2RND4RE2U3BL3BUE",
    "D7ND2R4E2UH2L4",
    "BD9U7E2R2FDG2DFRFDGL3", // D0-DF

    "BF6G3LH2U2E2R3FD5BU8BL3H",
    "BF6G3LH2U2E2R3FD5BU8BL3E",
    "BF6G3LH2U2E2R3FD5BU8BL2HG",
    "BF6G3LH2U2E2R3FD5BU9BLGHG",
    "BF6G3LH2U2E2R3FD5BU8BL2D0BL2D0",
    "BF6G3LH2U2E2R3FD5BU8BL3D0",
    "BD4ERFD4GLHUER5U2HLGD4FRE",
    "BR6BD4HL3G2D2F2R3EBG2NUDL",
    "BD6R6UH2L2G2D2F2R3EBU7BL3H",
    "BD6R6UH2L2G2D2F2R3EBU7BL3E",
    "BD6R6UH2L2G2D2F2R3EBU7BL2HG",
    "BD6R6UH2L2G2D2F2R3EBU7BL2D0BL2D0",
    "BR2FBD2D6",
    "BR4GBD2D6",
    "BR3NGNFBD3D6",
    "BR2BDD0BR2D0BLBD2D6", // E0-EF

    "BR4DNLNRD3FD2G2L2H2U2E2R2F",
    "BD3D2ND4E2R2F2D4BU9BLGHG",
    "BD5D2F2R2E2U2H2L2G2BE4BLH",
    "BD5D2F2R2E2U2H2L2G2BE4BLE",
    "BD5D2F2R2E2U2H2L2G2BE4HG",
    "BD5D2F2R2E2U2H2L2G2BE4NEHG",
    "BD5D2F2R2E2U2H2L2G2BE4D0BL2D0",
    "BD4R6BU3BL3D0BD6D0",
    "BD5D2F2R2E2U2H2L2NG2BR4G6",
    "BD3D4F2R2E2ND2U4BH2H",
    "BD3D4F2R2E2ND2U4BH2BUG",
    "BD3D4F2R2E2ND2U4BH2HG",
    "BD3D4F2R2E2ND2U4BH2D0BL2D0",
    "BD3D4F2R2E2NU4D3G2L4BU11BR3E",
    "D7ND5F2R2E2U2H2L2G2",
    "BD3D4F2R2E2NU4D3G2L4BU11BR2D0BR2D0"}; // F0-FF
...
LDRRFFDDGLLLLLLGDFGDDRRFRERREEUEREUEFRRERRFFFRFRDDLLLLRFRUREURULHLHHHEF",
    "5EUROPE",
    "+006+50",
    "RRERRRRUELLUHHLLREULLELLDGHDUFDEGRDRRLFDLLRGRRGGL",
    "5ENGLAND",
    "+008+55",
    "GLFGRRREUULL",
    "5IRELAND",
    "+023+64",
    "RRFRERRREHLLLLLGHLLRFLLRFL",
    "5ICELAND",
    "-011+80",
    "DDURFRERLGRRLLFRRREEFRRRLHGELLLHRRFRRRRERLLLLLLLLLLLDHGULLL",
    "5SVALBARD",
    "-014+45",
...
HURRFFRFRRRDRRFRRRRRRRF",
    ...
    "5CYPRUS",
    "-052+37",
    "LLHUURHUHUHERERRRDDLLLFFDDURFLLDFDDL",
    "0CASPAIN SEA",
    "-060+44",
    "LLUEERDFLDL",
    "0ARAL SEA",
...
ERRFGRFDGRRREUHHUREUE",
    ...
    "6SRI LANKA",
    "-121+18",
    "LDDDRDDRHRRFFDDDLLEHDULRHDFDDGERDDREUUULUUHHLHEUUL",
    "2PHILIPPINES",
    "-131+43",
...
LGGLDRFGHLLLHLLLLRFGHLGLLLULGLLLGLLHRHLDDDLLLLDLLLFLLHUHLRRFRRRREHLLHLLLHLLL",
    ...
    "6SIBERIAN I.",
    "-091+80",
    "FERDRRRRRRULLLLLRRULLLLGL",
    "6SEVERNAYA",
    "-101+79",
    "GRRRRELLLL",
    "6ZEMLYA",
    "-068+77",
    "LLGLLLLLLGLLGGLGLRFRRRRLHERERERRRERRRREL",
    "6NOVAYA",
    "+123+49",
...
RHLHLHGHLHLLGLLEHFRRRHLLLLLLGLDFHLUELLGG",
    "4BAFFIN I.",
    "+125+72",
    "RFRREERRRLLGFFRRRRRLLLLLFRRRRRRRREFRRRRHRRLHLHHLRRULGLFLHLDLLULLLLHLLLLLLL"
    "DG",
    "4VICTORIA I.",
    "+141+70",
...
UHUEEEREEUUUUHUUUHUEUEEEEEREEUEUEEUUULLGLLLLHUHHLHUUHHUUHHUUHUHHUU",
    "1AFRICA",
    "-049-12",
    "DGGGLGDDDDGDDFFREUEUEUUUEUUUUH",
    "1MADAGASCAR",
    "-032+00",
    "DDDREUELLL",
    "0LAKE VICTORIA",
...
HHHHHHUUHHHUULDDDDGDGHLHLHEUELLLHLFLLULDRGDDLLHLGG",
    ...
    "2FIJI",
    "-130+00",
    "FRFRLGFEFRFRFDGRRFRRUERFFFRRRLHHHHRHLHHLHLLHGGLHUHLGH",
    "2NEW GUINEA",
    "-115-04",
    "RUUEEURHUUEHHGGGGLLDDHLDDFDDRRDERF",
    "2BORNEO",
    "-095+06",
    "DFFFFFFDFFFFRUUUHFRHLHLUHHHHHLLH",
    "2SUMATRA",
    "-106-06",
    "GRFRRRRRRFRRHLHLLLLLHL",
    "2JAVA",
    "-120+00",
    "DGDDRDFHUEDFRHUHREFHLGHURRRRELLLLG",
    "2CELEBES",
    "+000-70",
...
Llul7u4l4Uu6Rr4UUu9Ll10ULl11",                               // Eridanus
    ...
    "551805+"
    "51Dd2rDDl3d4l7Dd8r8u2Rr9dRr2Dd6r10Uu6RUu2l2u3l2ul2Uu9Rr3UUu2LLldLl5",
    // Hercules
...
Al Thalimaim Anterior,Bered,Deneb el Okab Australis,Deneb el Okab Borealis",
    ...
    "thAra,Ara,beAra,ep-1Ara,zeAra,etAra,deAra,gaAra",
    "0_1_2,1_3_4_5_6_7", // Ara
...
ge,Asellus Primus,Asellus Tertius",
    "0_1_2_3,1_4_5_6_7_8_1,7_9_10_11_9",
    // Bootes
...
us",
 ...
 Tertia,etCen,Ke Kwan,psCen,Menkent,Kabkent Secunda,dCen,Alhakim",
    "0_1_2_3_4\
...
dr",
    "0_1_2_0_3_4_5_6_7_2,7_8_9", // Cepheus
    "Kaffaljidhma,Menkar,muCet,xi-2Cet,Phycochroma,Mira,Baten Kaitos,Altawk,Deneb\
 Algenubi,Deneb Kaitos,Diphda,taCet",
    "0_1_2_3_0_4_5_6_7_8_9_10_11_6",
    // Cetus
    ...
    "gaCrA,Alfecca Meridiana,beCrA,deCrA,thCrA",
    "0_1_2_3_4", // Corona Australis
    "ioCrB,epCrB,deCrB,gaCrB,Alphecca,Nusakan,thCrB", "0_1_2_3_4_5_6",
    // Corona Borealis
    "Alchiba,Minkar,Kraz,Algorab,Gienah", "0_1_2_3_4_1", // Corvus
    "thCrt,epCrt,Labrum,Alkes,Alsharasif,gaCrt,zeCrt,etCrt",
    "0_1_2_3_4_5_6_7,2_5\
",                                           // Crater
    "Gacrux,Acrux,Mimosa,Decrux", "0_1,2_3", // Crux
    "Deneb,nuCyg,zeCyg,Gienah Cygni,Sador,Albireo,Ruc,io-2Cyg,kaCyg",
    "0_1_2_3_4_\
...
ealis,Nodus I,Aldhibain,thDra,Edasich,Thuban,Ketu,Giansar",
    "0_1_2_3_4_5_2,1_\
...
,gEri,eEri,Acamar,ioEri,kaEri,chEri,Achernar",
    "0_1_2_3_4_5_6_7_8_9_10_11_12_\
...
Her,Rukbalgethi Shemali,phHer,chHer",
    "0_1_2_3_4_5_6_7_8,9_10_11_12_13_14_15_\
...
oHya,thHya,Hydrobius,Ashlesha,Mautinah,Al Minliar al Shuja,etHya",
    "0_1_2_3_4\
_5_6_7_8_9_10_11_12_13_14_15_16_13",                           // Hydra
    ...
    "Arneb,zeLep,etLep,deLep,gaLep,Nihal,Sasin,muLep,laLep",
    "0_1_2_3_4_5_0_7_6_5\
,7_8", // Lepus
    "Kakkab,zeLup,epLup,Thusia,Hilasmus,Kekouan,etLup,chLup,ph-1Lup",
    "0_1_2_3_4_\
5,1_6_7_8_6_3",                                                         // Lupus
...
ior,Han,Sabik,Imad,45Oph",
    "0_1_2_3_4_5_6_7_8_9_10_11,2_9,4_8", // Ophiuchus
    "ch-2Ori,xiOri,nuOri,muOri,Betelgeuse,Meissa,Bellatrix,Tabit,pi-2Ori,pi-1Ori,\
omi-1Ori,pi-5Ori,pi-6Ori,Saiph,Alnitak,Alnilam,Mintaka,Rigel",
    "0_1_2,1_3_4_5\
_6_7_8_9_10,7_11_12,13_14_15_16_17,14_4_6_16", // Orion
    "dePav,Peacock,gaPav,bePav,laPav,xiPav,etPav,epPav,zePav",
    "0_1_2_3_0_4_5_6_0\
_7,0_8", // Pavo
    "pi-2Peg,Matar,Scheat,psPeg,Algenib,Markab,Homam,Biham,Enif,muPeg,Sadalbari,i\
oPeg,Jih",
    "0_1_2_3_4_5_6_7_8,5_2_9_10_11_12", // Pegasus
    "laPer,muPer,dePer,Mirfak,gaPer,Miram,taPer,ioPer,thPer,phPer,Misam,Algol,Gor\
gona Tertia,epPer,Menkib,zePer,Atik",
    "0_1_2_3_4_5_6_7_8_9,4_6,3_7_8_9,7_10_1\
1_12,11_13_14_15_16,2_13",                                     // Perseus
    ...
    "Fomalhaut,epPsA,muPsA,thPsA,ioPsA,Tien Kang,gaPsA,Aboras",
    "0_1_2_3_4_2_5_6_\
7_0", // Piscis Austrinus
    "Naos,Turais,Azmidiske,k01Pup,pPup,Ahadi,Kaimana,Al Rihla",
    "0_1_2_3_4_5_6_7",
    // Puppis
    ...
    "Chow,kaSer,Ainalhai,Qin,Unukalhai,Nulla Pambu,Leiolepis",
    "0_1_2_0_3_4_5_6",
    // Serpens Caput
...
litha Australis,Talitha,El Kophrah,psUMa,Tania Australis,Tania Borealis,Alula\
 Borealis,Alula Australis",
    "0_1_2_3_4_5_6_7_8_9_10_11_12,3_6,7_9_5,4_13_14_1\
5_16,13_17_18", // Ursa Major
    "Polaris,Yildun,Urodelus,Alifa Al Farkadain,etUMi,Pherkad,Kochab",
    "0_1_2_3_4\
_5_6_3", // Ursa Minor
